    ...
    return (
        <View className="flex-1 flex justify-end">
            ...
            <LinearGradient colors={['transparent', '#18181b']}
                ...
                className="flex justify-end pb-12 spacy-y-8"
            >
                <Animated.View entering={FadeInDown.delay(100).springify()} className="flex items-center">
                    ...
                    <Text style={{ fontSize: hp(5) }} className="text-white font-bold tracking-wide"> For <Text className="text-rose-500">You</Text></Text>
                </Animated.View>
